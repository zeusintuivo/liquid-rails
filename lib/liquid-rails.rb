...
require "rails"
require "liquid"
require "liquid-rails/register_engine"
...
module Liquid
  module Rails
    class Railtie < ::Rails::Railtie
      ...
      initializer "liquid_rails.configure_template_digestor" do |app|
        Liquid::Rails::RegisterEngine.register_engine(app, config)
          ...
          ActiveSupport.on_load(:after_initialize) do
            begin # rubocop:disable Style/RedundantBegin
              if defined?(CacheDigests::DependencyTracker)
                ...
                CacheDigests::DependencyTracker.register_tracker :liquid, CacheDigests::DependencyTracker::ERBTracker
                ...
                ActionView::DependencyTracker.register_tracker :liquid, ActionView::DependencyTracker::ERBTracker
              end
            rescue
